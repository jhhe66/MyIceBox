...
public interface HelloPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /**
     * Contacts the remote com.jhhe.service.Server to verify that the object implements this type.
    ...
    /**
     * Contacts the remote com.jhhe.service.Server to verify that a facet of the object implements this type.
     * Raises a local exception if a communication error occurs.
     * @param obj The untyped proxy.
    ...
    /**
     * Downcasts the given proxy to this type without contacting the remote com.jhhe.service.Server.
     * @param obj The untyped proxy.
